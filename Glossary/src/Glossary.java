...
public final class Glossary {
    ...
    /**
     * @param input
     * @return single term out of index
     */
     ...
     * @param q
     */
    private static void replaceTerm(Map<String, String> map, Queue<String> q) {
        ...
        while (tempKeyMap.size() != 0) {
            ...
            while (pos < value.length()) {
                String token = nextWordOrSeparator(value, pos, separatorSet);
                tokenTemp = token;
                if (!separatorSet.contains(token.charAt(0))) {
                    ...
                    while (tempQ.length() > 0) {
                        ...
                        if (token.equals(key2)) {
                            tokenTemp = "<a href=\"" + key2 + ".html\">" + key2
                                    + "</a>";
                        }
                        q.enqueue(key2);
                    }
    ...
    /**
     * @param map
     * @return All Keys inside of the map into a queue
     */
     ...
     * @param folderName
     */
    private static void outputHeader(Map<String, String> map, SimpleWriter out,
            String folderName) {
